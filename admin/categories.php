        ...
        switch ($_POST['action']) {
            ...
            case 'edit':
                ...
                if ($existing_category) {
                    ...
                    if ($image_path && $existing_category['image'] !== 'categories/default.jpg') {
                    ...
                    $updated_category = [
                        ...
                        'slug' => generateSlug($_POST['name']),
                        'description' => $_POST['description'],
                        'image' => $image_path ? $image_path : $existing_category['image'],
                        'parent_id' => (int)$_POST['parent_id'],
                        'active' => isset($_POST['active']),
                        'featured' => isset($_POST['featured'])
                    ];
            ...
            case 'delete':
                ...
                if ($category_to_delete) {
                    ...
                    if ($category_to_delete['image'] !== 'categories/default.jpg') {
