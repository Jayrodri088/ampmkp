...
<a href="<?= getAdminUrl('admins.php') ?>" class="flex items-center px-4 py-3 <?= isActivePage('admins', $activePage ?? null) ? 'text-white bg-folly hover:bg-folly-600' : 'text-charcoal-200 hover:text-white hover:bg-charcoal-700' ?> transition-colors">
    <i class="bi bi-shield-fill-check mr-3 w-5 text-center"></i>
    Admin Users
</a>
<?php endif; ?>
